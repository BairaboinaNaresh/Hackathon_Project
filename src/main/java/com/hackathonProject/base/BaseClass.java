...
//
//            // Use local msedgedriver.exe to bypass Selenium Manager DNS issue
//            org.openqa.selenium.edge.EdgeDriverService service =
//                new org.openqa.selenium.edge.EdgeDriverService.Builder()
//                    .usingDriverExecutable(new java.io.File("C:\\Users\\2485872\\Downloads\\edgedriver_win64\\msedgedriver.exe"))
//                    .build();
//            webDriver = new EdgeDriver(service, edgeOptions);
//            logger.info("Edge browser launched (via local driver) with unique profile");
            ...
            default:
                throw new IllegalArgumentException(
                        "Unsupported browser: " + browser +
                                ". Supported browsers are: chrome, edge, firefox"
                );
        }
